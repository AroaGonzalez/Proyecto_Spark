# -*- coding: utf-8 -*-
"""3.2. Top 10 most profitable actors/actresses.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GZH2jZba3NsABTOUHyYSUjsHCuJaVkL3
"""
...
actor_profit_df = spark_df.groupBy('actor').sum('profit').withColumnRenamed('sum(profit)', 'total_profit')

sorted_actor_profit_df = actor_profit_df.orderBy(F.desc('total_profit'))

top_10_actors = sorted_actor_profit_df.limit(10)
