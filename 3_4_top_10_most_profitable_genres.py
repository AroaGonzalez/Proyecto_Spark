# -*- coding: utf-8 -*-
"""3.4. Top 10 most profitable genres.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KELqtoufG_F5Lo_faOH7-LrW77I5nuHZ
"""
...
genres_profits = spark_df.groupBy('genres').sum('profit').withColumnRenamed('sum(profit)', 'total_profit')

sorted_genres = genres_profits.orderBy('total_profit', ascending=False)

top_10_genres = sorted_genres.limit(10)
